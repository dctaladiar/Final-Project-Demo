...
public class Saving {
	...
	public Saving(double balance, int accountId) {
		super();
		this.balance = balance;
	...
	public int transferToAnotherAccount(Saving anotherAccount, double amount, double totalAmountWithdrewOnADay) {
		if((totalAmountWithdrewOnADay + amount) > 50000 ) {
			return 2;
	...
	public int overrideTransferOfFundsToOtherAccount(Saving anotherAccount, double amount) {
