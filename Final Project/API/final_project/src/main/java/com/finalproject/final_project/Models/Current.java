...
public class Current {
	...
	public Current(double balance, int accountId) {
		super();
		this.balance = balance;
	...
	public int withdraw(double amount, double totalAmountWithdrewOnADay) {
		...
		if((totalAmountWithdrewOnADay + amount) > 50000 ) {
			return 2;
		} else if(amount <= this.getBalance() && (this.getBalance() - amount >= 5000.00)) {
			this.balance -= amount;
			return 1;
		} else {
			return 0;
	...
	public int transferToAnotherAccount(Current anotherAccount, double amount, double totalAmountWithdrewOnADay) {
		if((totalAmountWithdrewOnADay + amount) > 50000 ) {
			return 2;
		} else if(this.getBalance() > amount && (this.getBalance() - amount >= 2000.00)) {
	...
	public int overrideTransferOfFundsToOtherAccount(Current anotherAccount, double amount) {
